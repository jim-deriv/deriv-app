...
export const switchAccountType = async (page: Page, from_type: string, to_type: string) => {
    await page.screenshot({ path: 'screenshots/switchAccountType1.png' });
    await page.waitForLoadState('domcontentloaded');
    await page.screenshot({ path: 'screenshots/switchAccountType2.png' });
    ...
    await page.waitForLoadState('domcontentloaded');
    await page.screenshot({ path: 'screenshots/switchAccountType3.png' });
};
